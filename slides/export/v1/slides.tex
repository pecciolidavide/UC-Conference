...
\date{17 agosto 2026}
\title[Compattezza e \(\null^*\R\)]{Teorema di Compattezza e Numeri Reali non-standard}
\begin{document}

\maketitle
\begin{frame}[label={sec:org0f88330}]{Domanda}
...
\end{frame}
\begin{frame}[label={sec:orgb036e09}]{Teorema di Compattezza}
\begin{block}{Teorema}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf9283c5}]{Partiamo dall'inizio}
\begin{block}{Esempio}
...
\end{frame}
\begin{frame}[label={sec:org17c96ba}]{\null}
Ricordiamo che
\begin{align*}
\N &= \set{0,1,2,\dots,}\\
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf3dc7e7}]{Modelli ed enunciati}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org64a228a}]{Teoria}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org73b7e3e}]{Teorema di Compattezza}
...
\end{frame}
\begin{frame}[label={sec:org84c2832}]{Teoria per i reali non-standard}
...
\end{equation*}
\end{frame}
\begin{frame}[label={sec:org989b470}]{La teoria è soddisfacibile?}
...
\end{frame}
\begin{frame}[label={sec:orgc7ddf91}]{Concludendo\ldots{}}
